...
impl<'a> AccountingSubscriptions<'a> {
    pub async fn account_orders<F, Fut>(&self, mut callback: F) -> Result<(), Error>
    where
    ...
    pub async fn account_persistent_orders<F, Fut>(&self, mut callback: F) -> Result<(), Error>
    where
    ...
    pub async fn account_trade_history<F, Fut>(&self, mut callback: F) -> Result<(), Error>
    where
    ...
    pub async fn account_order_history<F, Fut>(&self, mut callback: F) -> Result<(), Error>
    where
    ...
    pub async fn account_portfolio<F, Fut>(&self, mut callback: F) -> Result<(), Error>
    where
    ...
    pub async fn account_summary<F, Fut>(&self, mut callback: F) -> Result<(), Error>
    where
    ...
    pub async fn account_rfqs<F, Fut>(&self, mut callback: F) -> Result<(), Error>
    where
    ...
    pub async fn account_rfq_history<F, Fut>(&self, mut callback: F) -> Result<(), Error>
    where
