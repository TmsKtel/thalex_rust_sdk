...
pub struct UserInboxNotificationsNotification {
    /// Channel name as in subscription.
    #[serde(rename = "channel_name")]
    pub channel_name: String,
    #[serde(rename = "notification")]
    pub notification: models::Notifications,
}

impl UserInboxNotificationsNotification {
    pub fn new(
        channel_name: String,
        notification: models::Notifications,
    ) -> UserInboxNotificationsNotification {
        UserInboxNotificationsNotification {
            channel_name,
            notification,
        }
